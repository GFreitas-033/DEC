...
router.post('/', asyncHandler(async (req, res) => {
    const { qtd_maxima, id_professor, dia_semana, horario } = req.body;
    await turmaModel.createTurma(qtd_maxima, id_professor, dia_semana, horario);
...
router.put('/:id', asyncHandler(async (req, res) => {
    ...
    const { qtd_maxima, id_professor, dia_semana, horario } = req.body;
    await turmaModel.updateTurma(id_turma, qtd_maxima, id_professor, dia_semana, horario);
