...
export default function  Content_cadastro_Unidade(props){
    ...
    return(
        <div className={StyleCadastroUnidade.ContentC}>
            <h1 className={StyleCadastroUnidade.titulo}><Texto text={props.texto}/></h1>

            <form className={StyleCadastroUnidade.content} autoComplete="off"> 
                ...
                <div className={StyleCadastroUnidade.divBtn} onClick={()=>navigate(props.url)}>
